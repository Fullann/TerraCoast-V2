...
export const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "home.readyToTest": "Prêt à tester vos connaissances en géographie?",
    "home.accountBanned": "Compte banni",
    "home.temporaryBanUntil": "Votre compte est temporairement banni jusqu'au",
    "home.permanentBan": "Votre compte est banni de manière permanente",
    "home.reason": "Raison",
    ...
    "home.totalSessions": "Total de vos sessions",
    ...
    "home.discoverNewChallenges": "Découvrez de nouveaux défis",
    "home.shareKnowledge": "Partagez votre savoir",
    "home.trainingMode": "Mode Entraînement",
    "home.noTimeLimit": "Sans limite de temps",
    "home.challengeFriend": "Défier un ami",
    ...
    "quizzes.subtitle": "Explorez et jouez à des quiz créés par la communauté",
    ...
    "quizzes.noQuizCreated": "Vous n'avez pas encore créé de quiz",
    "quizzes.noQuizShared": "Aucun quiz partagé avec vous",
    "quizzes.tryDifferentFilters": "Essayez de modifier vos filtres",
    ...
    "quizzes.publishRequestSuccess":
      "Demande envoyée ! Un administrateur validera votre quiz.",
    ...
    "quizzes.confirmDelete": "Êtes-vous sûr de vouloir supprimer le quiz '{title}' ? Cette action est irréversible.",
...
"quizzes.deleteQuiz": "Supprimer le quiz",
    ...
    "friends.title": "Amis",
    "friends.subtitle": "Gérez vos amis et tchattez ensemble",
    ...
    "duels.title": "Duels",
    "duels.subtitle": "Affrontez vos amis en temps réel",
    ...
    "duels.createOrAccept": "Créez un duel ou acceptez une invitation",
    "duels.vs": "vs",
    "duels.youPlayed": "Vous avez joué",
    ...
    "duels.rate": "Taux",
    "duels.gap": "Écart",
    "duels.yourScore": "Votre score",
    "duels.chooseFriend": "Choisir un ami",
    "duels.selectFriend": "Sélectionnez un ami",
    "duels.chooseQuiz": "Choisir un quiz",
    "duels.selectQuiz": "Sélectionnez un quiz",
    "duels.sending": "Envoi...",
    ...
    "chat.selectFriend": "Sélectionnez un ami pour commencer à discuter",
    "training.title": "Mode Entraînement",
    "training.subtitle": "Pratiquez sans limite de temps et sans gagner d'XP",
    ...
    "training.feature3": "Choisissez le nombre de questions",
    "training.feature4": "Validation immédiate avec explications",
    "training.step1": "1. Choisissez un quiz",
    ...
    "share.successMessage": "Vos amis peuvent maintenant y accéder",
    "share.shareWith": 'Partagez "{title}" avec vos amis',
    ...
    "imageDropzone.invalidType":
      "Veuillez sélectionner une image (JPG, PNG, GIF, WebP)",
    ...
    "imageDropzone.dragHere": "Glissez une image ici",
    "imageDropzone.orClickToSelect": "ou cliquez pour sélectionner",
    ...
    "editQuiz.atLeastOneQuestion": "Ajoutez au moins une question",
    ...
    "editQuiz.subtitle": "Éditez votre quiz de géographie",
    ...
    "editQuiz.descriptionPlaceholder": "Décrivez votre quiz...",
...
"editQuiz.deleteQuestionError": "Erreur lors de la suppression de la question",
    ...
    "createQuiz.subtitle": "Créez votre propre quiz de géographie",
    "createQuiz.quizType": "Type de quiz",
    "createQuiz.noType": "Aucun type",
    "createQuiz.randomizeQuestions": "Mélanger l'ordre des questions",
    "createQuiz.randomizeAnswers": "Mélanger l'ordre des réponses (QCM)",
    ...
    "createQuiz.trueFalse.description":
      "Pour les questions Vrai/Faux, les options sont automatiquement définies. Sélectionnez simplement la bonne réponse ci-dessous.",
    ...
    "createQuiz.errors.maxQuizReached":
      "Vous avez atteint la limite de 10 quiz publics",
    "createQuiz.errors.createError": "Erreur lors de la création du quiz",
    "playQuiz.selectAnswer": "Veuillez sélectionner ou entrer une réponse",
    ...
    "playQuiz.yourAnswer": "Votre réponse",
    ...
    "playQuiz.enterAnswer": "Entrez votre réponse...",
  ...
  en: {
    ...
    "quizzes.confirmDelete": "Are you sure you want to delete the quiz '{title}'? This action is irreversible.",
...
"editQuiz.deleteQuestionError": "Error deleting question",
  ...
  it: {
    ...
    "quizzes.deleteQuestionsError": "Errore durante l'eliminazione delle domande",
