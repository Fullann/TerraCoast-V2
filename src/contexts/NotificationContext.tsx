...
export function NotificationProvider({ children }: { children: ReactNode }) {
  ...
  const [duelNotification, setDuelNotification] = useState<DuelNotification | null>(null);
  ...
  const clearFriendRequestNotification = () => setFriendRequestNotification(null);
  ...
  useEffect(() => {
    ...
    // ✅ 2. Écouter les nouvelles demandes d'amis
    ...
    // ✅ 3. Écouter les nouvelles invitations de duel
    ...
    // ✅ 4. Écouter quand une invitation est acceptée
    ...
    // ✅ 5. Écouter quand un duel est terminé
